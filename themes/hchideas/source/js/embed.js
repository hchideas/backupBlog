...
function sskadmin(e) {
    var ssk = '';
    if (e.user_id == 6313007357282484993) {
        if (checkMobile()) {
            ssk = '<span class="ua"><span class="sskadmin"神童博主</span></span><div style="position:absolute;margin-left:300px;width:300px;height:100px;"><img src="http://ok7yt1lk3.bkt.clouddn.com/zhanzhang.png"></div>';
        } else {
            ssk = '<span class="ua"><span class="sskadmin"><p><font size="4" face="verdana" color="#FFFFFF">神童博主</font></p></span></span><div style="position:absolute;margin-left:300px;width:300px;height:100px;"><img src="http://ok7yt1lk3.bkt.clouddn.com/zhanzhang.png"></div>';
        }
    } else {
        if (checkMobile()) {
            ssk = '<br><br>';
